 ...
 *
 * The unique uid has 64bits (long), default allocated as blow:<br>
 ...
 * <li>worker uid: The next 22 bits, represents the worker's uid which assigns based on database, max uid is about 420W
 ...
 * <pre>{@code
 * +------+----------------------+----------------+-----------+
 * | sign |     delta seconds    | worker node uid | sequence  |
 * +------+----------------------+----------------+-----------+
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        // initialize worker uid
        workerId = workerIdAssigner.assignWorkerId();
        if (workerId > bitsAllocator.getMaxWorkerId()) {
            throw new RuntimeException("Worker uid " + workerId + " exceeds the max " + bitsAllocator.getMaxWorkerId());
        }
    ...
    public long getUID() throws UidGenerateException {
        try {
            ...
            LOGGER.error("Generate unique uid exception. ", e);
